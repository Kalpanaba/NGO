...
const FounderMessage = () => (
  <section className="relative p-6 md:p-12 flex flex-col md:flex-row items-center bg-blue-400 shadow-lg rounded-lg overflow-hidden">
    ...
    <div className="md:w-2/3 text-white text-center md:text-left">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-black">Founder's Message</h2>
